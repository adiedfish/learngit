...
gcn = model.Model()
hidden_num = 15
layer1 = layers.gcn_layer("1",(features.shape[1],hidden_num),sparse_martix,0)
...
for i in range(epochs):
	sess.run(gcn.train(0.001),feed_dict={gcn.inputs:features,gcn.labels_for_train:labels_for_train})
